  ...
  return (
    ...
    >
      ...
      <div
        ...
        role="dialog"
        aria-label="Search V1 documentation"
      >
        <div className={styles.cmdkInp}>
          ...
          <input
            ref={inputRef}
            type="text"
            placeholder="Search the V1 docs…"
            autoComplete="off"
            spellCheck={false}
            value={query}
        ...
        <div className={styles.cmdkResults} ref={resultsRef}>
          {!flatResults.length ? (
            <div className={styles.cmdkEmpty}>
              No matches. Try “Coinpath”, “transfers”, or “BSC”.
            </div>
          ) : (
        ...
        <div className={styles.cmdkFoot}>
          ...
          <span className={styles.cmdkBrand}>Bitquery V1 Docs</span>
        </div>
      </div>
    </div>
  );
